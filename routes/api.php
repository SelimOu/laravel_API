...
Route::get('/v1/welcome', [ProductController::class,'welcome'])->name('welcome');
Route::post('/v1/register',[UserController::class,'register'])->name('Userstore');
Route::post('/v1/login', [UserController::class,'login'])->name('Userindex');
...
Route::get('/product/categorie/{id}', [ProductController::class, 'filtreCate'])->name('filtreCate');
